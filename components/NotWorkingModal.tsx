    ...
    >
      ...
      <div className="fixed inset-0 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4 text-center">
          <DialogPanel
            transition
            className="w-full max-w-md transform overflow-hidden rounded-2xl bg-slate-900 p-6 text-left align-middle shadow-xl ring-2 ring-slate-600 transition-all duration-300 ease-out data-[closed]:scale-95 data-[closed]:opacity-0"
          >
            <DialogTitle
              as="h3"
            ...
            <div className="mt-2">
              <p className="text-sm text-slate-500">
                If the website does not accept Pashword then that means their
                security is possibly flawed.
                <br /> <br /> We can&apos;t fix the website but we can make
                Pashword better for you and others. Please submit the following
                details so we can update Pashword&apos;s algorithm for this
                website, so you never have to do this ever again.
              </p>
            </div>
            <div className="mt-2 flex flex-col gap-2 text-sm sm:text-base">
              ...
              <div className="flex flex-row items-center">
                ...
                >
                  ...
                  />
                  <span className="sr-only">No numbers allowed</span>
                </Switch>
              </div>
              <div className="flex flex-row flex-wrap items-center text-slate-200">
                ...
                <input
                  ...
                  value={notWorkingForm.max === -1 ? "" : notWorkingForm.max}
                ...
                />
                {notWorkingForm.max > 0 && (
                  <AiFillCheckCircle className="inline-block text-lg text-green-400" />
                )}
              </div>
              <div>
                <p className="text-slate-300">Additional Message (if any):</p>
                <textarea
